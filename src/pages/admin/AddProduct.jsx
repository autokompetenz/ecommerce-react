...
export default function AddProduct() {
  ...
  return (
    <div className="admin-form-wrap">
      <h1 className="admin-page-title">Produkt hinzufügen</h1>
      ...
      <form onSubmit={handleSubmit} className="admin-form">
        ...
        <div>
          ...
          <input name="category" value={form.category} onChange={handleChange} placeholder="z.B. Schraubendreher, Schlagschlüssel, Bohrmaschinen..." className="admin-input" />
        </div>
        ...
        <div className="admin-form-actions">
          <button type="submit" disabled={loading} className="btn btn-primary">
            {loading ? "Wird gesendet..." : "Produkt hinzufügen"}
          </button>
